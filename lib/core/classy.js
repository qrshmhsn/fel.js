...
;(function(exports, undefined) {
  ...
  Class.$extend = function(properties) {
    ...
    prototype.$base = super_prototype;
    ...
    var rv = function() {
      ...
      if (proper_this.__init__){
        if("$base" in proper_this && "__init__" in proper_this.$base)
          proper_this.$base.__init__.apply(proper_this, arguments);
