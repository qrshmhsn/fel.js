				...
				__classvars__ : {
	        		...
	        		get: function(id, callback){
	        			model.db.get(id, function(obj){
	        				model.bd_response_to_model(obj, callback);
	        			});
	        		},
	        		...
	        		bd_response_to_model: function(obj, result_callback){
	        			if(!obj)
	        				return null;
	        				...
	        				function(vt, callback){
								...
								if(prop_name in obj.value){
									...
									if(_.isObject(prop_type[prop_name]) && 
											prop_type[prop_name].model){
										var m = prop_type[prop_name].model;
	        		...
	        		bd_results_to_models: function(objs, callback){
	        			async.map(
        					objs, 
